#!/bin/bash
# Test: Send Cross-Sell Promotion Email to pheath@twilio.com
# Uses PROMO_EMAIL_TEMPLATE_ID with first_name dynamic field

BASE_URL="https://sfbli-2271-dev.twil.io"
ENDPOINT="${BASE_URL}/send-email"

echo "========================================="
echo " Cross-Sell Promotion Email"
echo "========================================="
echo "Endpoint: ${ENDPOINT}"
echo "To:       pheath@twilio.com"
echo "Template: d-cf44cc750c25457cb9788f92811441d9 (PROMO_EMAIL_TEMPLATE_ID)"
...
RESPONSE=$(curl -s -w "\n%{http_code}" -X POST "${ENDPOINT}" \
  ...
  -d '{
    ...
    "templateId": "d-cf44cc750c25457cb9788f92811441d9",
